...
idxs_plus = df[df["sex"] == "Male"].index.intersection(X_train.index)
X_train_plus = X_train.loc[idxs_plus, :]
y_train_plus = y_train.loc[idxs_plus]

idxs_minus = df[df["sex"] == "Female"].index.intersection(X_train.index)
X_train_minus = X_train.loc[idxs_minus, :]
y_train_minus = y_train.loc[idxs_minus]
